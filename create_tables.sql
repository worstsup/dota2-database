...
-- Функции, создаваемые позже тем же владельцем, не должны автоматически получать EXECUTE для PUBLIC
...
-- Аналитик: SELECT всех таблиц, включая логи
GRANT SELECT ON ALL TABLES IN SCHEMA public TO analyst;
GRANT USAGE ON ALL SEQUENCES IN SCHEMA public TO analyst;

-- Игрок: SELECT со всех таблиц кроме логов
GRANT SELECT ON ALL TABLES IN SCHEMA public TO player;
GRANT USAGE ON ALL SEQUENCES IN SCHEMA public TO player;
REVOKE ALL ON TABLE Logs FROM player;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA public
GRANT SELECT ON TABLES TO player;

ALTER DEFAULT PRIVILEGES IN SCHEMA public
GRANT EXECUTE ON FUNCTIONS TO admin;

ALTER DEFAULT PRIVILEGES IN SCHEMA public
GRANT EXECUTE ON FUNCTIONS TO analyst;

ALTER DEFAULT PRIVILEGES IN SCHEMA public
GRANT EXECUTE ON FUNCTIONS TO player;
